...
- **Enable_AD_Recycle_Bin.ps1**: Enables the Active Directory Recycle Bin for the forest, verifies status and replication; requires ActiveDirectory module and admin rights. Must be run as a Domain Admin!!!
```powershell
